...
final class PromotionsView: UIView {
    ...
    private let images = Observable.just([#imageLiteral(resourceName: "introSliderItem2"), #imageLiteral(resourceName: "introSliderItem2"), #imageLiteral(resourceName: "introSliderItem1")])
